<x-auth-layout>
    ...
    <div class="row h-100">
        <div class="col-lg-5 col-12">
            <div id="auth-left">
                <div class="auth-logo">
                    <a href="/"><img src="{{ asset('assets/static/images/logo/logo-telu.png') }}" alt="Logo"></a>
                </div>
                <h1 class="auth-title">Sign Up</h1>
                <p class="auth-subtitle mb-4 text-center">Aplikasi Hitung Prediksi Kebangkrutan dengan Model Grover</p>
                ...
                <form action="{{ route('auth.register.store') }}" method="POST">
                    ...
                    <button class="btn btn-danger btn-block btn-lg shadow-lg mt-2">Sign Up</button>
                </form>
